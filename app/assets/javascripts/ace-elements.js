...
!function (a, b) {
    var c = function (c, d) {
        ...
        function l() {
            if (W !== !1) {
                ...
                v ? N || (b += z.outerWidth() - O) : N || (c += z.outerHeight() - O), W === !0 ? B.css({top: parseInt(c), left: parseInt(b)}) : "left" === W ? B.css("left", parseInt(b)) : "top" === W && B.css("top", parseInt(c))
            }
        }
    ...
    a.fn.ace_scroll = function (d, e) {
        ...
        return f === b ? g : f
    }, a.fn.ace_scroll.defaults = {size: 200, horizontal: !1, mouseWheel: !0, mouseWheelLock: !1, lockAnyway: !1, styleClass: !1, observeContent: !1, hideOnIdle: !1, hideDelay: 1500, hoverReset: !0, reset: !1, dragEvent: !1, touchDrag: !0, touchSwipe: !1, scrollEvent: !1, detached: !1, updatePos: !0}
    ...
    g.error = {FILE_LOAD_FAILED: 1, IMAGE_LOAD_FAILED: 2, THUMBNAIL_FAILED: 3}, g.prototype.apply_settings = function () {
        ...
        if (d && 0 != d.length) {
            ...
            for (var g = 0; g < d.length; g++) {
                ...
                var l = {file: "fa fa-file", image: "fa fa-picture-o file-image", video: "fa fa-film file-video", audio: "fa fa-music file-audio"}, m = l[i];
                if (this.well_style) {
    ...
    var h = function () {
        ...
        var c = this, d = c.$label.find(".ace-file-name:last"), e = new a.Deferred, h = function (b) {
            ...
            var i = h.w, j = h.h;
            "small" == c.settings.thumbnail && (i = j = f), a(b).css({"background-image": "url(" + h.src + ")", width: i, height: j}).data("thumb", h.src).attr({src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg=="}).show(), e.resolve()
        }, j = function () {
        ...
        return f ? (/^data\:image\/(png|jpe?g|gif);base64,[0-9A-Za-z\+\/\=]+$/.test(f) || (f = null), f ? {src: f, w: d, h: e} : null) : null
    }, l = function (a, b) {
    ...
    a.fn.aceFileInput = a.fn.ace_file_input = function (c, d) {
        ...
        return e === b ? f : e
    }, a.fn.ace_file_input.defaults = {style: !1, no_file: "No File ...", no_icon: "fa fa-upload", btn_choose: "Choose", btn_change: "Change", icon_remove: "fa fa-times", droppable: !1, thumbnail: !1, allowExt: null, denyExt: null, allowMime: null, denyMime: null, maxSize: !1, before_change: null, before_remove: null, preview_error: null}
    ...
    }, a.fn.bs_typeahead.defaults = {source: [], items: 8, menu: '<ul class="typeahead dropdown-menu"></ul>', item: '<li><a href="#"></a></li>', minLength: 1}, a.fn.bs_typeahead.Constructor = b, a.fn.bs_typeahead.noConflict = function () {
    ...
    a.fn.ace_wysiwyg = function (b) {
        ...
        return this.each(function () {
            ...
            b += " </div> ";
            var k;
            c.speech_button && "onwebkitspeechchange"in(k = document.createElement("input")) && (b += ' <input class="wysiwyg-speech-input" type="text" data-edit="inserttext" x-webkit-speech />'), k = null, b += " </div> ", b = c.toolbar_place ? c.toolbar_place.call(this, b) : a(this).before(b).prev(), b.find("a[title]").tooltip({animation: !1, container: "body"}), b.find(".dropdown-menu input[type=text]").on("click", function () {
                return!1
            }).on("change", function () {
    ...
    function (a) {
        a.fn.aceTree = a.fn.ace_tree = function (b) {
            var c = {"open-icon": ace.vars.icon + "fa fa-folder-open", "close-icon": ace.vars.icon + "fa fa-folder", selectable: !0, "selected-icon": ace.vars.icon + "fa fa-check", "unselected-icon": ace.vars.icon + "fa fa-times", loadingHTML: "Loading..."};
            return this.each(function () {
    ...
    function c(b, c) {
        ...
        this.initiate = function () {
            ...
            ace.vars.touch ? m.addClass("overflow-scroll").css("max-height", c + "px") : m.hasClass("ace-scroll") || m.ace_scroll({size: c, reset: !0, mouseWheelLock: !0, lockAnyway: !this.settings.body_scroll, styleClass: this.settings.scroll_style, observeContent: !0, hideOnIdle: !ace.vars.old_ie, hideDelay: 1500}), d.off("resize.modal.aside").on("resize.modal.aside", function () {
